        ...
        <div className="mb-8 md:mb-16">
          ...
          >
            ...
            <p className="text-lg text-gray-400">
              All VPS plans are powered by the high-performance <span className="font-extrabold">AMD Ryzen™ 7 7700</span> processor
            </p>
          </motion.div>
          <motion.div 
          ...
          >
            ...
            >
              <div className="p-4 md:p-6">
                ...
                <div className="mb-4">
                  <span className="text-2xl md:text-3xl font-bold text-purple-400">$7.70</span>
            ...
            >
              <div className="p-4 md:p-6">
                ...
                <div className="mb-4">
                  <span className="text-2xl md:text-3xl font-bold text-purple-400">$8.70</span>
                  <span className="text-gray-400">/month</span>
                </div>
                <ul className="space-y-3 mb-6">
            ...
            >
              <div className="p-4 md:p-6">
                ...
                <div className="mb-4">
                  <span className="text-2xl md:text-3xl font-bold text-purple-400">$13.70</span>
                  <span className="text-gray-400">/month</span>
                </div>
                <ul className="space-y-3 mb-6">
            ...
            >
              <div className="p-4 md:p-6">
                ...
                <div className="mb-4">
                  <span className="text-2xl md:text-3xl font-bold text-purple-400">$18.70</span>
                  <span className="text-gray-400">/month</span>
                </div>
                <ul className="space-y-3 mb-6">
